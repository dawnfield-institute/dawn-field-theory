...
# --- Modular TinyCIMM ---
class TinyCIMM(nn.Module):
    """
    Modular PyTorch implementation of TinyCIMM with self-regulating structure, entropy controls, and symbolic adaptation.
    Now fully self-contained with all structure learning, entropy/feedback adaptation, QBE penalty, micro-memory, frequency awareness, and adaptation logic.
    """
    ...
    def forward(self, x, y_true=None):
        ...
        if self.current_step % 50 == 0:
            print(f"[TinyCIMM DEBUG] Step {getattr(self, 'current_step', 0)}")
