...
This directory contains implementations and validations of theory arithmetic concepts derived from Dawn Field Theory. The core discovery is that **Fibonacci arithmetic underlies both semantic computation and physical reality**.
...
See: [`../experiments/pac_confluence_xi/papers/10_PAC_CONFLUENCE_XI_SYNTHESIS.md`](../archive/era2-prefield/pac_confluence_xi/papers/10_PAC_CONFLUENCE_XI_SYNTHESIS.md)
...
python experiments/studies/euclidean_distance_validation/experiments/experiment_07_real_embeddings.py
...
- **[PROPOSAL.md](../experiments/studies/euclidean_distance_validation/PROPOSAL.md)**: Original theoretical proposal
- **[RESULTS.md](../experiments/studies/euclidean_distance_validation/RESULTS.md)**: Complete experimental validation (7 experiments)
- **[METHODS.md](../experiments/studies/euclidean_distance_validation/METHODS.md)**: Reproducibility guidelines
- **[README.md](../experiments/studies/euclidean_distance_validation/README.md)**: Project overview and architecture
...
**Note**: Hodge mapping represents earlier theory work. Integration with PAC theory and euclidean distance validation is planned.
...
- **Constants Lineage**: See [constants_derivation_lineage.md](derivations/constants_derivation_lineage.md) for SEC cost and PAC-Lazy provenance
...
This is a theory research project. Contributions should:
