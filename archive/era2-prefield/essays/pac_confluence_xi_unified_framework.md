...
1. PAC Confluence Xi experimental series (`archive/era2-prefield/pac_confluence_xi/`)
2. PAC Turbulence Theory (`archive/era2-prefield/PACEngine/docs/PAC_TURBULENCE_THEORY.md`)
3. Bell Resolution documentation (archive/era2-prefield/pac_confluence_xi/papers/11_BELL_RESOLUTION_PAC_SEC_UNIFICATION.md)
...
- `papers/standalone/qbe_pac_unification/Code/experiments/validated/` — Production code
- `archive/era1-symbolic/PACEngine/modules/` — PAC mesh and turbulence analysis
- `archive/era2-prefield/pac_confluence_xi/data/` — Experimental results
