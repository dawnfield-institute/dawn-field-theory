...
We adopt the operator formalism from [infodynamics_arithmetic_v1.md](../../../formal/derivations/infodynamics_arithmetic_v1.md):
...
![Collapse tree example](../language_to_logic/reference_material/2025-06-21_102536/testid_1/collapse_tree.png)
...
This appendix summarizes and references key theory documents and operator definitions:

- [infodynamics_arithmetic_v1.md](../../../formal/derivations/infodynamics_arithmetic_v1.md): Defines ⊕, ⊗, δ, [I:H], Ψ(Σ), and the structural evolution equation. Diagnostics: `collapse_balance_field_score`, `average_branching_factor`. Validation: `recursive_entopy.py`, `recursive_tree.py`.
- [symbolic_geometry_arithmetic.md](../../../formal/derivations/symbolic_geometry_arithmetic.md): Collapse pressure Π(x, y), entropy modulation γ(x, y), recursive balance R(x, y), symbolic prune and drift operators. Diagnostics: entropy maps, active symbol ratio, persistence distributions.
- [hodge_mapping.md](../hodge_mapping/v0.1/hodge_mapping.md): Symbolic-to-Hodge map φ_k, rationality/integrality test ψ, symbolic cycle extraction Z(F), mapping to cohomology classes. Validation: symbolic field attractor analysis, mod-p stability, FFT harmonic coherence.
