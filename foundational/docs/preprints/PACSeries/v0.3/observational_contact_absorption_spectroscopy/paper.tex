...
\textbf{Peter Groom, Dawn Field Institute} \textbf{PACSeries Paper 12} \textbf{Date}: June 2026 \textbf{Version}: 1.0 (Draft)
...
\textbf{SDSS DR16 MgII}: 89,291 systems ($z = 0.35$–$2.28$) from MPA-Garching. \textbf{SDSS DR16 FeII-confirmed}: 52,872 systems with 4 transitions. \textbf{SDSS DR12 CIV}: 443,000 systems ($z = 1.4$–$5.0$) from Monadi et al. (2023). \textbf{XQR-30}: 5,764 components, 42 sightlines ($z = 2.0$–$6.5$), 8 ionic species (Davies et al. 2023).
