...
\textbf{Peter Groom, Dawn Field Institute} \textbf{PACSeries Paper 11} \textbf{Date}: May 2026 \textbf{Version}: 1.0 (Draft)
...
\textbf{Source code}: \texttt{foundational/experiments/milestone14/} (11 experiments + P13–P16 scripts)
