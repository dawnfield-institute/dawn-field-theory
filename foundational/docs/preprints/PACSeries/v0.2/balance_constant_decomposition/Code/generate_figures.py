...
def main():
    ...
    # Fig 7 is generated by a separate script (generate_fig7.py) because it
    # requires reality-engine on PYTHONPATH.  Run it independently:
    #   python generate_fig7.py
    print("\nNote: Fig 7 (Möbius convergence) is generated separately via generate_fig7.py")
