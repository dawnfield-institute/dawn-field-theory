...
[`foundational/lexicon.yaml`](../../lexicon.yaml), where each term carries the era it was
...
| `information_amplification` | The 15.56× "universal constant" that **was not one**. Its correction is Entry 1 of [`EPISTEMIC_CORRECTIONS_REGISTRY.md`](../../../EPISTEMIC_CORRECTIONS_REGISTRY.md) — the first formal honest-failure record. |
...
Eras 3 and 4 are not archived and remain under `foundational/experiments/`.
