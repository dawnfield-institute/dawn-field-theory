...
- `papers/MILESTONE1_PAPER.md` - Complete academic paper with derivation chain
- `papers/DERIVATION_CHAIN.md` - Step-by-step mathematical derivation
- `papers/FALSIFICATION_METHODOLOGY.md` - How we distinguish from numerology
