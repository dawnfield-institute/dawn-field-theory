...
PAC conservation is the foundational axiom of DFT:
...
The information paradox is the sharpest test of quantum gravity. DFT's foundational axiom (PAC conservation) is literally information conservation. If any framework is positioned to resolve the paradox, it's one built on information conservation from the ground up.
