...
**Source**: [navier-stokes](../navier-stokes/), [sec_prime_manifold](../sec_prime_manifold/), [sec_threshold_detection](../sec_threshold_detection/)
...
**Source**: [macro_emergence_dynamics](../../../arithmetic/macro_emergence_dynamics/), specifically [depth_2_recursion_insight.md](../../../arithmetic/macro_emergence_dynamics/insights/depth_2_recursion_insight.md)
...
**Source**: [pac_confluence_xi](../pac_confluence_xi/), [standard_model_connection](../standard_model_connection/), especially [2025-12-07_fibonacci_derivation_breakthrough.md](../standard_model_connection/journals/2025-12-07_fibonacci_derivation_breakthrough.md)
...
**Source**: [pre_field_recursion](../pre_field_recursion/), [internal/maxwell/charge_from_sec_collapse.py](../../../../internal/maxwell/charge_from_sec_collapse.py)
...
**Source**: [pre_field_recursion](../pre_field_recursion/), Möbius theoretical framework
...
- [unified_pac_framework_comprehensive.md](../../../arithmetic/unified_pac_framework_comprehensive.md) - PAC mathematical foundation
- [confluence_operator_recursive_arithmetic.md](../../../arithmetic/confluence_operator_recursive_arithmetic.md) - Ξ operator theory

### Key Experiments (Direct Dependencies)

| Experiment | What It Provides | How It Connects |
|------------|------------------|-----------------|
| [pac_confluence_xi](../pac_confluence_xi/) | sin²θ_W = 3/13 | EM-weak mixing from Fibonacci |
...
| [navier-stokes](../navier-stokes/) | SEC wave dynamics | c from SEC parameters |
...
| [pre_field_recursion](../pre_field_recursion/) | Möbius topology | Pre-field structure |
