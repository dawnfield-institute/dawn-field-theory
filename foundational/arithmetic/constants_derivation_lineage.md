...
2. Anti-periodic boundary condition: f(u + π) = -f(u)
   └── Source: experiments/pre_field_recursion/core/mobius_topology.py
...
- `experiments/pi_harmonics/results.md` - π-harmonic validation
- `experiments/pre_field_recursion/notes/pi_harmonic_fmas_discovery.md` - π in recursion
- `experiments/standard_model_connection/journals/2025-12-06_mobius_fibonacci_chain.md` - Full derivation
- `experiments/pac_confluence_xi/papers/08_FIBONACCI_INDEX_DERIVATION.md` - Why F₁₀
...
- `experiments/pac_confluence_xi/papers/03_ALPHA_DERIVATION_BREAKTHROUGH.md`
...
- `experiments/sec_prime_manifold/scripts/exp_33_sec_robustness_no_phi.py` - Falsification test
- `experiments/phi_artifact_test/REVISED_CONCLUSIONS.md` - Analysis
