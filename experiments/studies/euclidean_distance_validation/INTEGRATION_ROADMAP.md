...
2. **Information Amplification** (`papers/standalone/symbolic_entropy_collapse/Code/`) - Quantum validation
3. **PAC Series** (`papers/drafts/PACSeries/`) - Theoretical predictions
