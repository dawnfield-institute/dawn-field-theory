...
| [information_amplification](../archive/era2-prefield/information_amplification) | Attractor detection via potential gradients | Reuse attractor clustering algorithms |
