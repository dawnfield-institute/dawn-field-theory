...
Key script: [experiment_22_xi_modulation.py](../euclidean_distance_validation/experiments/experiment_22_xi_modulation.py)
...
Key module: [pac_sec_unification.py](../../../archive/era2-prefield/PACEngine/modules/pac_sec_unification.py)
...
- [PAC Confluence Xi Synthesis Paper](../../../archive/era2-prefield/pac_confluence_xi/papers/10_PAC_CONFLUENCE_XI_SYNTHESIS.md)
- [PAC-SEC Unification Module](../../../archive/era2-prefield/PACEngine/modules/pac_sec_unification.py)
- [EDV Experiment 22](../euclidean_distance_validation/experiments/experiment_22_xi_modulation.py)
