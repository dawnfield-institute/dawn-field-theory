...
| experiments/studies/landauer_erasure_structure/papers/journal.md | Full theoretical writeup (PACSeries Paper 1 candidate) |
| experiments/studies/landauer_erasure_structure/papers/addendum_ln_phi_emergence.md | ln(φ) derivation addendum |
