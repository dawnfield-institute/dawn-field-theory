...
- `theory/essays/base_agnostic_pac_invariants.md` - Full documentation
- `experiments/studies/base_agnostic_pac/scripts/exp_10_base_agnostic_pac.py` - Core validation
- `experiments/studies/base_agnostic_pac/scripts/exp_11_entropy_analysis.py` - Entropy tests
- `experiments/studies/base_agnostic_pac/scripts/exp_12_zeckendorf_validation.py` - Base-φ analysis
