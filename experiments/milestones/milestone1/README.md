...
- [pac_confluence_xi](../archive/era2-prefield/pac_confluence_xi) — Ξ discovery and Standard Model derivation
...
- [pre_field_recursion](../archive/era2-prefield/pre_field_recursion) — Möbius dynamics (exp_27)
...
- [quantum_validation](../archive/era1-symbolic/quantum_validation) — Quantum tests (exp_31)
- [information_amplification](../archive/era2-prefield/information_amplification) — SEC amplification (exp_32)
