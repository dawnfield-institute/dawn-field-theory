...
- `experiments/milestones/milestone1/` — PAC/SEC → SM derivation chain
- `experiments/milestones/milestone2/` — Mass derivation deep dive
- `papers/series/PACSeries/v0.2/structure_cost_of_erasure/Data/` — Paper 1 source experiments
- `papers/PREPRINT_UPDATE_PLAN.md` — Master consolidation plan
