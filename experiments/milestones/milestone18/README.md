...
## Scorecard: 56/77 — Phases 3–8, Block D and Block F run (A 12/12 · B 3/5 + 7: 1/2 + 7b: 1/2 + 7c: 1/2 · C 6/8 · C-ext 21/29 · D 2/3 · Phase 8 4/7 · E 4/4 · F 1/3)
...
| **F — Orientation** | Does the ℤ₂ of the deck transformation have a spectral face on the first non-tree class? Signed graphs, both switching classes (balanced = a global gauge exists; twisted = the Möbius class) | exp_20 | **1/3** | **RUN 2026-09-07** — sealed `872c3ad2` (`journals/2026-09-07_blockF_registration.md`; reading `journals/2026-09-07_local_global_delta.md`), outcomes `journals/2026-09-07_exp20_outcomes.md`. On the pure cycle everything is a theorem — three filed: the twist selects the odd exponents and doubles the conductor (strict iff d = 2 and 4 \| n; the balanced zero mode is "the root", the twisted class has none); on M15's instrument H_tw = ε·S·H_bal·S⁻¹, so **C₆ = −I becomes I**; the cover doubles the cyclomatic number — and theorems are gates (KA-1..8), not tests. On 61,131 signed unicyclic graphs × 2 classes: **T1 PASS** — the parity law holds on the first non-tree class (strict over √5 only at n = 8 and 12: 3 and 21, in both classes; 0 at 6, 10, 14 and every odd n); **T2 FAIL** as sealed — beyond the cycle the twist moves fields both ways (112/1,040 exceptions at n ≤ 10, every field lost somewhere); **T3 FAIL** as sealed, informative — at n ≡ 2 (mod 4) the obstruction is an odd-multiplicity rational factor of degree ≥ 2, not a root (639 of 2,889 root-free signed graphs pair over √5, all partial) |
...
**Theorems filed: 13 (three on the signed cycle, 2026-09-07) · open conjectures: 8 · killed: 2 (polynomial integrality 09-02; exact denominator 09-04) · retired: 1 (Block D reach, 2026-09-03)** — in [`formal/theorems/`](../../../formal/theorems/README.md)
