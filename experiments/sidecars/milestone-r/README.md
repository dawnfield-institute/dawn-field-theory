...
## Status: Active | Score: 71/128 (55%)

Predicted: 27/40 (68%). Actual: 71/128 (55%) after 31 experiments. Sidecar milestone -- does not continue M14->M15 chain.
...
| 29 | The Ledger on Particles (reality-engine v4 substrate) | E | 3/4 | **THE LEDGER HOLDS THE WEB; WHOSE WEB IT IS DEPENDS ON THE SIZE.** exp_28's zero located: the SEC pressure is a gradient at fixed entropy and the whole non-conservation is the entropy ratchet (pair energy created by entropy change 689,700 vs pressure work 667,300); the substrate had NO ledger. Added: a per-particle potential budget P(0) = kappa |U_grav(0)| paying for entropy growth at the price the pair energy sets; KE + U + E_SEC + sum P conserved (sealed `43e4ebc9`). T2 PASS at both sizes: bound, KE/|U_grav| 0.49-0.54 at kappa = 0.5 and 0.29-0.36 at 1 vs 10.7-22.3 unbounded, at every window mark. T3 PASS: KE/|U| ordered kappa 1 < 2 < inf, 6/6. T4 PASS: net creation <= P(0) exactly, the budget binds on every would-grow particle. **T1 FAIL at both sizes, and the registered KILL fires**: at kappa = 0.5 the web survives (0.51-0.76 proxy, 0.44-0.78 at n = 4000, vs 0.03-0.10 unbounded, 4.8-5.7 sigma) but against gravity alone it wins 2/3 on the proxy (0.2 sigma) and 3/3 at n = 4000 by 1.1 sigma against a 2-sigma bar. **Unscored, post hoc: at n = 4000 kappa = 1 holds 0.70-0.80, above gravity alone in every seed by 2.8 sigma, and kappa = 2 collapses; on the proxy (pressure range 2 r0 = 20 > half its box) the engine never adds.** The virial prediction (bound through kappa = 1; U-shaped KE/|U| with its minimum at 1) held in all six seeds. **Retired: the mapping as the object that holds structure beyond gravity at kappa = 0.5 with the proxy deciding. Kept: the ledger discipline as a gated instrument. Next: R1b -- kappa = 1 at n = 4000 on fresh seeds, the box-to-range ratio declared.** (`journals/2026-09-06_exp29_outcomes.md`) |
| 30 | R1b: The Ledger at κ = 1, Fresh Seeds (reality-engine v4 substrate) | E | 3/4 | **THE 2.8σ WAS SEED SELECTION; THE KILL FIRES.** exp_29's post-hoc κ = 1 margin tested as a registered claim on fresh seeds {4, 5, 6} at n = 4000 (box/2r0 = 3.0 declared as a condition; the proxy at 1.89 retired as a decider), sealed `a4ab7a68`. **T1 FAIL**: κ = 1 holds 0.851 / 0.572 / 0.793 against gravity alone 0.645 / 0.631 / 0.684 -- 2/3 seedwise, margin 0.085, pooled σ 0.106, 0.8σ. The κ = 1 arm reproduced its mean (0.74 vs 0.75); the control moved -- gravity alone is high and tight on the fresh seeds (0.65 ± 0.03) where it was low and spread on seeds 1-3 (0.44 ± 0.15). T2 PASS: bound at κ = 1 (max KE/|U| 0.34-0.38) and at the never-run κ = 1.5 (0.46-0.47). T3 PASS: κ = 1.5's position predicted before it was run -- KE/|U| 1 < 1.5 < ∞ and percolation 1 > 1.5, 3/3 on both; κ = 1.5 holds 0.19-0.39, below gravity, with the pressure's net work positive (+0.2 P0) where at κ ≤ 1 it is negative (-0.8 to -4.3 P0). T4 PASS: exact, within allowance, binds 3/3. **Retired: the mapping as a structure-ADDER. Kept: the ledger as the bound-maker** (KE/|U| 0.33-0.36 at κ = 1). Exploring, unscored: over all six seeds the ledgered arms sit above gravity in 11/12 seed-arm pairs at 1.0-1.6σ, and the best-looking arm moved from κ = 1 (seeds 1-3) to κ = 0.5 (seeds 4-6) -- seed noise with the arm chosen after the fact; not chased. Next: R2 on the bound substrate at κ = 1 (one budget step below the edge where the web goes; κ = 0.5 for margin is a registration call); the pressure's form is the only lead for an adder claim. (`journals/2026-09-14_exp30_outcomes.md`) |
| 31 | R1c: Connectivity at Matched Occupancy, Paired, Fresh Seeds (reality-engine v4 substrate) | E | 3/4 | **THE LEDGERED ENGINE ADDS CONNECTIVITY TO GRAVITY'S WEB.** exp_30's post-mortem re-specified the adder question (paired on seed; connectivity of the densest q of cells on a CIC count field, occupancy matched by construction; no mass draw), sealed `b8ff9125` and pushed before any run; six fresh seeds 7-12, κ ∈ {0, 0.5, 1, 1.25, ∞}. **T1 PASS**: Δ conn_q10(κ = 0.5 − 0) = +0.065 ± 0.015, 6/6, paired t 4.4; the legacy percolation lifts +0.092 (t 6.1, 6/6) -- exp_29's claim at this budget was right and its unpaired d > 2 bar at n = 3 could not see it. **T2 FAIL**: the spine clause hit a ceiling -- gravity's densest 5% is already one component (0.99-1.00) on three seeds, lift zero there and +0.07..+0.13 on the three with headroom (3/6 against ≥ 5/6); the contrast clause held 6/6 (ratio 0.99-1.13). T3 PASS: κ = 1's predicted signature -- body up 6/6, spine down 6/6, contrast 0.57-0.61 of gravity's 6/6. T4 PASS: net pressure work positive at κ = 1.25 (+0.08..+0.15 P0) and negative at 1 (−0.79..−1.18) in 6/6; spine collapsed at 1.25 in 6/6. **Reading: a modest, consistent lift at κ = 0.5 that leaves the web gravity's (contrast, occupancy, void unchanged); κ = 1 is a different regime; 1.25 is past the edge. R2's substrate is κ = 0.5.** T2's saturating sign clause is a registration design error, recorded. (`journals/2026-09-14_exp31_outcomes.md`) |
| **Total** | | | **71/128** | **55% -- exploratory sidecar** |
...
42. **A PAC ledger makes the particle substrate bound, and whose web it then holds depends on the size** -- with a per-particle potential budget paying for entropy growth at the price the SEC pair energy sets (exp_29), the substrate settles at KE/|U_grav| ~ 0.5 (10.7-22.3 unbounded), the total KE + U + E_SEC + sum P is conserved, and a web survives at both sizes (4.8-5.7 sigma over the unbounded engine). Against gravity alone the registered arm (kappa = 0.5) fails the 2-sigma bar at both sizes; post hoc, at n = 4000 kappa = 1 holds more web than gravity in every seed (2.8 sigma) and kappa = 2 less, while on the proxy -- whose pressure range exceeds half its box -- the engine never adds. A bounded density-sourced repulsion is not structurally inert on a box large compared with its range. The virial arithmetic stated before the run held at every seed. The box-to-range ratio was not declared; it is the lesson carried into R1b.
43. **The ledgered engine is a bound-maker, not a structure-adder, and the web goes where the bounded pressure's net work turns positive** -- on fresh seeds at n = 4000 with the box-to-range ratio declared (exp_30, sealed `a4ab7a68`), the κ = 1 arm's 2.8σ margin over gravity alone fell to 0.8σ (2/3 seedwise): gravity's own web is seed-variable (0.32-0.68 over six seeds) and the exp_29 margin was its two low seeds. What held: bound at κ = 1 and at the never-run κ = 1.5, whose position the virial arithmetic predicted (KE/|U| 1 < 1.5 < ∞; percolation 1 > 1.5, 3/3); and an edge -- at κ ≤ 1 the pressure's net work is negative (-0.8 to -4.3 P0) and the web stands at 0.57-0.85, at κ ≥ 1.5 it is positive (+0.2 to +0.3 P0) and the web is gone (0.09-0.39, below gravity). Over six seeds the ledgered arms sit above gravity in 11/12 pairs at 1.0-1.6σ: a small effect at most, unresolved, and not what Milestone R needs. R2 runs on the bound substrate.
44. **At matched occupancy, paired on the initial condition, the ledgered engine at κ = 0.5 adds connectivity to gravity's web -- and κ = 1 is a different regime with an edge one step above it** -- exp_31 (sealed `b8ff9125`, pushed before any run) re-asked exp_29/30's question with the pairing kept (one seed = one initial condition shared by every arm), the occupancy matched by construction (connectivity of the densest 10% of cells on a CIC count field; no mass draw on the threshold), six fresh seeds: +0.065 ± 0.015, 6/6, paired t 4.4, with contrast, occupancy and void fraction unchanged from gravity's; the legacy percolation lifts +0.092 (t 6.1) at the very budget exp_29 registered and failed under an unpaired d > 2 bar at n = 3. κ = 1's signature predicted from six seeds held on six others clause by clause (body more connected 6/6, spine less 6/6, contrast 0.57-0.61 of gravity's), and the edge sits between κ = 1 (net pressure work −0.8..−1.2 P0) and 1.25 (+0.08..+0.15 P0; spine collapsed 6/6). The spine clause of T2 saturated (gravity's densest 5% already one component on three seeds) and failed as registered. R2's substrate is κ = 0.5.

## Honest Failures (20 tests)
...
| The ledgered engine holds no more web than gravity alone at kappa = 0.5 | exp_29 T1: proxy 2/3 seeds vs gravity only, margin 0.032 vs pooled std 0.174; n = 4000 3/3 seeds, margin 0.174 vs pooled std 0.160 (1.1 sigma against a 2-sigma bar). 3/3 and 4.8-5.7 sigma vs the unbounded engine at both sizes. The registered kill fires: the mapping is retired as the object that holds structure beyond gravity at kappa = 0.5 with the proxy deciding. Unscored: at n = 4000 kappa = 1 beats gravity 3/3 at 2.8 sigma -- the arm was registered at the wrong budget and the proxy is in a finite-size regime (2 r0 > box/2). The ledger stays as an instrument. |
| The ledgered engine at κ = 1 holds no more web than gravity alone on fresh seeds | exp_30 T1: n = 4000, seeds 4-6: 0.851 / 0.572 / 0.793 vs 0.645 / 0.631 / 0.684 -- 2/3 seedwise, margin 0.085, pooled σ 0.106 (0.8σ against a 2σ bar). The 2.8σ of exp_29 was gravity's two low seeds. The registered kill fires: the mapping is retired as a structure-adder and kept as a bound-maker. T2-T4 pass, including κ = 1.5's predicted position. |
| The ledgered engine at κ = 0.5 does not reliably raise the connectivity of gravity's densest 5% | exp_31 T2: spine lift −0.005 / 0.000 / 0.069 / 0.000 / 0.130 / 0.082 -- 3/6 against a ≥ 5/6 bar (t 2.01). Gravity's spine is already one component (0.99-1.00) on seeds 7, 8, 10: a sign count registered on a statistic that saturates. The contrast clause held 6/6. T1 (the claim, at q = 0.10) passed 6/6 at t 4.4. A registration design error, recorded; the clause returns as "≥ in 6/6 and > wherever there is headroom" if it returns. |
...
| P39 | Directional | A PAC ledger (a potential budget paying for entropy growth at the pair-energy price) lets the particle substrate hold structure beyond gravity alone and beyond the unbounded engine | **HALF-CONFIRMED / KILLED exp_29**: bound and conserved (T2-T4 pass at both sizes; beyond the unbounded engine by 4.8-5.7 sigma) but not beyond gravity alone at the registered kappa = 0.5 (0.2 sigma proxy, 1.1 sigma at n = 4000). Post hoc at n = 4000, kappa = 1 beats gravity 3/3 at 2.8 sigma -- R1b registers it on fresh seeds. Sealed `43e4ebc9`. |
| P40 | Directional | The ledgered engine at κ = 1 holds more web than gravity alone at n = 4000 on fresh seeds, 3/3 at > 2σ (exp_29's post hoc, registered with the box-to-range ratio declared) | **FALSIFIED exp_30**: 2/3 seedwise, 0.8σ; gravity alone 0.65 ± 0.03 on seeds 4-6 vs 0.44 ± 0.15 on seeds 1-3 -- the margin was the control's seeds. Bound (T2), κ = 1.5's position predicted (T3), ledger exact (T4). Sealed `a4ab7a68`. |
| P41 | Directional | Paired on seed, at matched occupancy, the ledgered engine at κ = 0.5 adds connectivity to gravity's web on six fresh seeds (6/6, mean ≥ 0.05, paired t ≥ 3); κ = 1 fattens the web and breaks its spine; the edge is between κ = 1 and 1.25 | **CONFIRMED exp_31** (T1, T3, T4; T2's spine clause saturated): +0.065 ± 0.015, 6/6, t 4.4; κ = 1 body up 6/6, spine down 6/6, contrast 0.57-0.61; net pressure work −0.8..−1.2 P0 at 1 and +0.08..+0.15 at 1.25, 6/6. Sealed `b8ff9125`. |
