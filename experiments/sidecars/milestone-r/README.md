...
## Status: Active | Score: 68/124 (55%)

Predicted: 27/40 (68%). Actual: 68/124 (55%) after 30 experiments. Sidecar milestone -- does not continue M14->M15 chain.
...
| 31 | R1c: Connectivity at Matched Occupancy, Paired, Fresh Seeds (reality-engine v4 substrate) | E | — | **REGISTERED 2026-09-14, running.** exp_30's post-mortem re-specified the adder question: the design threw away its pairing (each seed is one initial condition shared by every arm), compared arms at unmatched occupancy (κ = 1's overdense set is 60% larger than gravity's), and read a mass-weighted threshold sitting on the count-two boundary (0.01-0.05 of instrument noise on the same positions). New instrument (reality-engine `5f5d690`): connectivity of the densest q of cells on a CIC count field -- occupancy matched by construction, no mass draw. Paired on seed, six fresh seeds 7-12, κ ∈ {0, 0.5 (claim), 1 (contrast), 1.25 (edge), ∞}, 30 runs. T1 κ = 0.5 adds connectivity at q = 0.10 (sign 6/6, mean ≥ 0.05, paired t ≥ 3); T2 it is gravity's web, better connected (spine ≥ 5/6, contrast within 15%); T3 κ = 1's predicted signature (body up, spine down, contrast halved); T4 the edge (net pressure work positive at 1.25, negative at 1, spine collapsed at 1.25). Kill: the adder question closes for this mapping at every budget; bound-maker is the final reading. Post-hoc priors on seeds 1-6 disclosed in §0; the κ sweep {0.25, 0.75, 1.25} on seeds 1-3 disclosed. (`journals/2026-09-14_exp31_registration.md`) |
| **Total** | | | **68/124** | **55% -- exploratory sidecar** |
