...
## Status: Active | Score: 65/120 (54%)

Predicted: 27/40 (68%). Actual: 65/120 (54%) after 29 experiments. Sidecar milestone -- does not continue M14->M15 chain.
...
| 30 | R1b: The Ledger at κ = 1, Fresh Seeds (reality-engine v4 substrate) | E | — | **REGISTERED 2026-09-14, running.** exp_29's unscored post-hoc (κ = 1 above gravity alone by 2.8σ at n = 4000, seeds 1-3) tested as a claim on fresh seeds {4, 5, 6}, full size only, with the box-to-range ratio declared as a condition (box/2r0 = 3.0 ≥ 3; the proxy at 1.89 retired as a decider for pressure-range questions). New arm κ = 1.5, position predicted. T1 the claim (κ = 1 > κ = 0, 3/3, > 2σ); T2 bound at κ = 1 and 1.5; T3 κ = 1.5's predicted position (KE ordering 1 < 1.5 < ∞ AND percolation 1 > 1.5); T4 the ledger did the work. Kill: the 2.8σ was seed selection; the mapping is retired as a structure-ADDER and kept as a bound-maker. (`journals/2026-09-14_exp30_registration.md`) |
| **Total** | | | **65/120** | **54% -- exploratory sidecar** |
