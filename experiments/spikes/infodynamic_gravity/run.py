...
def run_cosmic_web_experiment():
    ...
    os.system("python experiments/spikes/infodynamic_gravity/experiments/sec_enhanced_cosmic_web.py")
...
def run_parameter_investigation():
    ...
    import os
    if not os.path.exists("experiments/spikes/infodynamic_gravity/experiments/parameter_investigation.py"):
        print("Creating parameter investigation framework...")
        with open("experiments/spikes/infodynamic_gravity/experiments/parameter_investigation.py", "w", encoding='utf-8') as f:
...
''')
    ...
    os.system("python experiments/spikes/infodynamic_gravity/experiments/parameter_investigation.py")
