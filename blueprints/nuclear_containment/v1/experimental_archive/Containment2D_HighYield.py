...
def simulate_optimized_high_yield_containment_2d(
    grid_size=150,
    t_steps=400,
    dt=0.1,
    dx=1.0,
    ...
    """
    Simulates high-yield 2D field collapse with recursive nullification containment.
    """
    ...
    plt.title('Optimized High-Yield Blast Containment (2D)')
    plt.tight_layout()
    plt.show()
