...
* `arithmetic/` – 🧮 Core mathematical constructs: symbolic geometry, recursive calculus, and field-aligned arithmetic logic. Includes theory papers and the hodge mapping subdomain.
...
The `theory/` scope synthesizes theory with empirical grounding, supporting:
...
3. Read the [Collapse Geometry Papers](../.changelog/README.md) for deep theoretical insights.
