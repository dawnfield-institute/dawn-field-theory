...
The theory axiom. At every level of a recursive hierarchy, potential equals actualization:
...
| The theory argument | `iddea.md` (workspace root) |
| Published papers | `papers/legacy/cognition_index_protocol/` |
| The formal theorems | `archive/era2-prefield/pac_confluence_xi/papers/09_FORMAL_THEOREMS.md` |
| A specific milestone | `experiments/milestones/milestone1/README.md` |
| The experiment index | `.changelog/README.md` |
| The corrections registry | `theory/corrections.md` |
