...
class VolatilityAgent(BaseAgent):
    def __init__(self, manager):
        ...
        input_size = 4  # <- must match what CIMMCoreWrapper expects
        ...
        super().__init__("VolatilityAgent", VolatilityModel, param_space, manager, anchor_data, hidden_size=64, role="predictor")
